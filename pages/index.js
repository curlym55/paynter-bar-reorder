  ...
  return (
    <div style={{ padding: '32px', maxWidth: 900, margin: '0 auto' }}>
      ...
      <div style={{ background: 'linear-gradient(135deg, #1e3a5f 0%, #0e7490 100%)', borderRadius: 12, padding: '20px 24px', marginBottom: 24, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' }}>
        ...
        <button
          onClick={() => window.open('https://netorgft13493683-my.sharepoint.com/:w:/r/personal/paynterbar_gemwoods_com_au/_layouts/15/Doc.aspx?sourcedoc=%7B9AE00960-19BA-419D-AFF0-C07BFB559313%7D&file=PaynterHubProcedures.docx&action=download', '_blank')}
